...
def main():
    ...
    # 1. Basic Example
    run_command(
        ["python", "examples/1_basic_scoring.py"],
        desc="Basic Scoring Example"
    )
    ...
    if adv_ex.exists():
        run_command(
            ["python", "examples/2_advanced_config.py"],
            desc="Advanced Configuration Example"
        )
    ...
    bench_cmd = [
        ...
        "--mode", "quick",
        "--n_reps", "1",
        "--outdir", "dev/smoke_tests/output_bench_smoke"
    ]
