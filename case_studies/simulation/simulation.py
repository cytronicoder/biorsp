...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        choices=["1", "2", "3", "all"],
        default="all",
        help="Which simulation family to run (1=null calibration, 2=power, 3=robustness, all=all)",
    )
    ...
    # Run families based on selection
    if args.family in ["1", "all"]:
