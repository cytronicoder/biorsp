...
print(f"  Old approach: {old_sig_points} points in [0, 0.05] ({100*old_sig_points/n_total:.0f}%)")
print(f"  New approach: {new_sig_points} points in [0, 0.05] ({100*new_sig_points/n_total:.0f}%)")
