...
def generate_signal_field(
    ...
    if pattern == "uniform":
        ...
        phi = params.get("phi", 0.0)  # Gradient angle
...
def generate_expression_from_field(
    ...
    if expr_model == "bernoulli":
        ...
        abundance = params.get("abundance", 1e-3)
        phi = params.get("phi", 10.0)  # Inverse dispersion
...
def generate_confounded_null(
    ...
    if null_type == "iid":
        ...
        # Expression correlates with library size (sequencing depth)
        ...
        # Expression correlates with local cell density
        ...
        # Very low prevalence to stress sector masking
