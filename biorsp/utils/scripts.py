...
def add_common_args(parser: argparse.ArgumentParser):
    ...
    parser.add_argument(
        "--no_profiles", action="store_false", dest="save_profiles", help="Disable profiles"
    )
    parser.add_argument("--features", type=str, help="Comma-separated list of features to analyze")
    parser.add_argument("--features_file", type=str, help="Path to file with feature names")
