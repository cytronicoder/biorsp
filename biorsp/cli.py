    ...
    output = {
        "features": {
            name: {
                ...
                "localization_entropy": fr.summaries.localization_entropy,
                "localization_gini": fr.summaries.localization_gini,
                "m_valid_sectors": fr.summaries.m_valid_sectors,
                "sum_abs_rsp": fr.summaries.sum_abs_rsp,
                "localization_status": fr.summaries.localization_status,
                "r_mean": fr.summaries.r_mean,
                "r_median": fr.summaries.r_median,
                "polarity": fr.summaries.polarity,
                "a_signed": fr.summaries.a_signed,
                "frac_pos": fr.summaries.frac_pos,
                "frac_neg": fr.summaries.frac_neg,
                "signed_status": fr.summaries.signed_status,
